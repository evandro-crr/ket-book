...
\begin{table}[H]
 \centering
 \begin{tabular}{c}
  Camadas de Abstração \bigstrut \\ \hline
  ...
  Nível Físico
 \end{tabular}
\caption{Níveis de abstração -- um método útil para lidar com a complexidade de sistemas. As camadas de baixo são mais próximas do nível físico e as de cima são mais abstratas. Fonte: \cite{book:lcdf_mkm}}
\end{table}
