...
\begin{subsection}{Espaço Vetorial}
 ...
 \begin{remark}
  ...
  As matrizes referente a operadores lineares serão vistas na seção \ref{cap2:sec_matriz_tl}.
 \end{remark}
...
\begin{section}{\nohyphens{Produto Interno, Norma e Produto Exterior}}
 ...
 \end{itemize}
  ...
  \end{subsection}
   ...
   \begin{subsection}{\nohyphens{Matriz de uma Transformação Linear}}\label{cap2:sec_matriz_tl}
