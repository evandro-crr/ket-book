...
\chapter{Panorama Atual da Computação Quântica}\label{cap6:panorama_CQ}
...
\begin{section}{Motivação para Computação Quântica}
 
A \emph{lei de Moore}, formulada em 1965, previu que a capacidade computacional dos sistemas digitais dobraria a cada dois
...
(\!\!\cite{book:qcqi_nc}, p.4 e \cite{book:pqci_benenti}, p.2).
...
no processamento. (\!\!\cite{book:pqci_benenti}, p. 3).
...
ainda não explorados. (\!\!\cite{book:qcqi_nc}, p. 3).
...
\begin{section}{Expectativas de Mercado}
 
 A Gartner \cite{webinar:gartner} estima que a Computação Quântica será uma realidade no mercado dentro de 5 a 10 anos. Espera-se que essa tecnologia se torne mais rápida e escalável, de forma a tratar problemas reais que a computação atual não conseguiria abordar satisfatoriamente. A curva da figura \ref{cap6:fig_hype_cicle}, chamada \emph{hype-cicle}, mostra as tecnologias em alta no mercado e as que já atingiram maturidade. A posição da Computação Quântica é de subida na curva de expectativas. 
 \begin{figure}[H]
 \vspace{-10pt}
\centering
\includegraphics[scale=0.3]{cap6/figuras/hype_cicle_gartner.png}
\vspace{-10pt}
\caption{\emph{Hype-cicle} para tecnologias atuais. Posição da Computação Quântica destacada. Compare com \emph{Machine Learning} (topo da curva) e \emph{Realidade Virtual} (estabilização/maturidade). Fonte: Gartner \cite{webinar:gartner}.}
\label{cap6:fig_hype_cicle}
\end{figure}
  \vspace{-5pt}
...
\begin{figure}[H]
 \vspace{-8pt}
\centering
\includegraphics[scale=0.3]{cap6/figuras/eniac.jpg}
\vspace{-10pt}
\caption{ENIAC. Fonte: Computer History Museum \cite{site:comp_hist_museum}.}
\label{cap6:fig_eniac}
\end{figure}
 \vspace{-5pt}
 ...
 % e \ref{cap6:fig_aplic_cq_2} 
 mostra aplicações em que se espera utilizar processamento quântico.
 
  \begin{figure}[H]
\centering
\includegraphics[scale=0.4]{cap6/figuras/qc_applications.png}
\vspace{-6mm}
\caption{Expectativa de aplicação da Computação Quântica. Fonte: Gartner \cite{webinar:gartner}, adaptado de Pete Shadbolt e Jeremy O'Brien.}
\label{cap6:fig_aplic_cq_1}
\end{figure}

\begin{comment}
  \begin{figure}[H]
\centering
\includegraphics[scale=0.15]{cap6/figuras/qc_applications_2.png}
\caption{Expectativa de aplicação da Computação Quântica. Fonte: Gartner \cite{webinar:gartner}.}
\label{cap6:fig_aplic_cq_2}
\end{figure}
\end{comment}
...
\end{section}
 ...
 \begin{section}{Empresas e Desenvolvimentos Atuais}
 ...
 \subsubsection*{IBM}
   ...
   \noindent Fonte: \\
   \footnotesize
   \texttt{http://newsroom.ibm.com/IBM-research?item=30270} \\
   \texttt{http://newsroom.ibm.com/} \\
          \texttt{https://www.research.ibm.com/ibm-q/} \\
          %
          \texttt{https://quantumexperience.ng.bluemix.net/qx/experience} \\
          \texttt{https://qiskit.org/}\\
          \texttt{https://github.com/QISKit}\\
          \texttt{https://github.com/QISKit/openqasm}
    \normalsize
 ...
 \subsubsection*{Google}
  ...
  \noindent Fonte: \\
  \footnotesize
  \texttt{https://ai.googleblog.com/2018/03/a-preview-of-bristlecone-googles-new.html}\\
         \texttt{https://ai.googleblog.com/2015/03/a-step-closer-to-quantum-computation.html}\\
         \texttt{https://www.nature.com/articles/nature14270} \\
         %
         \texttt{http://www.quantumplayground.net} \\
         \texttt{https://opensource.google.com/projects/quantum-computing-playground}\\
         \texttt{https://github.com/gwroblew/Quantum-Computing-Playground}
  \normalsize
 ...
 \subsubsection*{Intel}
    ...
    \noindent Fonte:\\
    \footnotesize
    \texttt{https://newsroom.intel.com/news/intel-advances-quantum-neuromorphic-\\computing-research/}\\
           \texttt{https://newsroom.intel.com/press-kits/quantum-computing/}
     \normalsize
 ...
 \subsubsection*{Microsoft}
   ...
   \noindent Fonte:\\
   \footnotesize
   \texttt{https://www.microsoft.com/en-us/quantum/technology}\\
   \texttt{https://cloudblogs.microsoft.com/quantum/2017/12/11/announcing-microsoft-\\quantum-development-kit/}
   \normalsize
   
 \subsubsection*{Rigetti}
   ...
   A Startup Rigetti disponibiliza um processador quântico de 19 qubits e um ambiente de desenvolvimento, chamado Forest, para programação quântica. A empresa também disponibiliza um simulador, chamado Quantum Virtual Machine, de 26 qubits. A Rigetti também desenvolveu a linguagem open source Quil, que baseia-se em um modelo computacional clássico/quântico com memória compartilhada, e trabalha em uma biblioteca python para programação quântica, a pyQuil.
    ...
    \noindent Fonte: \\
    \footnotesize
    \texttt{https://www.rigetti.com/}\\
    \texttt{https://www.rigetti.com/forest} \\
    \texttt{https://github.com/rigetticomputing/pyQuil} 
    \normalsize
 
 \subsubsection*{Outras Startups e Empresas}
   
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{cap6/figuras/early_pioneers_in_qc.png}
\caption{Startups e empresas pioneiras em Computação Quântica. Fonte: Gartner \cite{webinar:gartner}.}
\end{figure}
 
 \begin{comment}
 \subsubsection*{Outras Empresas}
 ...
 Fonte:\\
 \texttt{http://www.scmp.com/tech/china-tech/article/2134520/alibaba-cloud-steps-its-game-it-offers-quantum-computing-service}\\
 \texttt{https://technode.com/2018/03/08/baidu-quantum-computing/}
 \end{comment}
...
\begin{comment}
\begin{section}{Principais Grupos de Pesquisa}

\begin{subsection}{Pesquisa em Computação Quântica no Brasil}
 ANUNCIE AQUI
\end{subsection}

\begin{subsection}{Instituições de Pesquisa Internacionais}
 ANUNCIE AQUI
\end{subsection}
